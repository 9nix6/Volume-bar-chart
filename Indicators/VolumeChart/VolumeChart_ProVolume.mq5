...
//
// Initialize VolumeBarChart indicator for data processing 
// according to settings of the VolumeBarChart indicator already on chart
//

#include <AZ-INVEST/SDK/VolumeChartIndicator.mqh>
VolumeChartIndicator customChartIndicator;
