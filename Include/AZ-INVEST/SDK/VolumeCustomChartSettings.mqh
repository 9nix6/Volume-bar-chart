...
//
      ...
      input ENUM_VOLUME_CHART_CALCULATION algorithm = VOLUME_CHART_USE_VOLUME; // Operating mode
      ...
      ENUM_VOLUME_CHART_CALCULATION algorithm = VOLUME_CHART_USE_VOLUME;   // Operating mode 
